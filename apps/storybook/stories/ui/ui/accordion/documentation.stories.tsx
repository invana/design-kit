...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger, Link } from '@invana/ui';
        ...
        <AccordionContent>
          <div className="space-y-3">
            ...
            <div className="mt-4 p-3 bg-muted rounded-md">
              <p className="text-base"><strong>Pro Tip:</strong> Start with our interactive tutorial to learn the basics in just 5 minutes!</p>
            </div>
          </div>
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="api">
        ...
        <AccordionContent>
          <div className="space-y-3">
            ...
            <div className="mt-3 p-3 bg-muted rounded-md font-mono text-base">
            ...
            <p className="text-base text-muted-foreground">
              Visit our <Link href="#">full API documentation</Link> for detailed endpoint information.
            </p>
          </div>
        </AccordionContent>
      </AccordionItem>
        ...
        <AccordionContent>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-base text-muted-foreground">Try resetting your password or clearing your browser cache.</p>
            </div>
            <div>
              <p className="font-medium mb-1">Features not loading?</p>
              <p className="text-base text-muted-foreground">Check your internet connection and try refreshing the page.</p>
            </div>
            <div>
              <p className="font-medium mb-1">Need more help?</p>
              <p className="text-base text-muted-foreground">Contact our support team at support@example.com or use the chat widget.</p>
            </div>
          </div>
        </AccordionContent>
      </AccordionItem>
