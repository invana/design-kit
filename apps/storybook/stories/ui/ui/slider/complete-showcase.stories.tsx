...
export const CompleteShowcase: Story = {
  ...
  render: () => (
    <div className="p-8 space-y-8 max-w-2xl">
      <div>
        <TypographyH5 className="mb-4">Basic Sliders</TypographyH5>
      ...
      <div>
        <TypographyH5 className="mb-4">Different Step Values</TypographyH5>
        <div className="space-y-6">
          <div className="space-y-2">
            <div className="flex justify-between">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-base text-muted-foreground">75%</span>
            </div>
      ...
      <div>
        <TypographyH5 className="mb-4">RGB Color Mixer</TypographyH5>
        <div className="space-y-4">
          <div className="space-y-2">
            <div className="flex justify-between">
              <Label htmlFor="red" className="text-red-500">Red</Label>
              <span className="text-base text-muted-foreground">255</span>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-base text-muted-foreground">128</span>
            </div>
