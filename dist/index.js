...
function MarkdownEditorBlock({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("relative border border-border bg-muted/40", className), ...props, children: [
    version != null ? /* @__PURE__ */ jsx("span", { className: "absolute right-1 top-1 z-10 border border-border bg-card px-1 text-sm text-muted-foreground", children: version }) : null,
    /* @__PURE__ */ jsx(
      "div",
      {
        ref,
