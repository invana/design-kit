...
function SpecChip({ chip }) {
  if (chip.bound) return /* @__PURE__ */ jsx(BoundChip, { bound: chip.bound });
  return /* @__PURE__ */ jsx(
    Badge,
    {
      ...
      Item,
      {
        ...
        children: [
          ...
          item.meta || item.chip ? /* @__PURE__ */ jsxs(ItemActions, { className: "min-w-0 shrink justify-end", children: [
            item.meta ? /* @__PURE__ */ jsx("span", { className: "max-w-[16ch] truncate font-mono text-meta text-muted-foreground", children: item.meta }) : null,
...
function TextPanel({ panel, options, onAction, icons }) {
  const body = /* @__PURE__ */ jsx("p", { className: cn("text-meta", TEXT_TONE[options.tone ?? "muted"]), children: options.text });
...
function UnknownPanel({ kind }) {
  return /* @__PURE__ */ jsxs("div", { className: "border border-dashed border-border p-3 text-meta text-muted-foreground", children: [
...
function Panel({
  ...
  const body = panel.render ?? (Renderer ? /* @__PURE__ */ jsx(
    Renderer,
    {
      panel,
...
function Row({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: row.panels.map((panel, i) => /* @__PURE__ */ jsx(
        Panel,
        {
          panel,
          registry,
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex min-h-0 flex-col bg-background", className), ...props, children: [
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        style: { gap },
        children: spec.rows.map((row, i) => /* @__PURE__ */ jsx(
          Row,
          {
            row,
            gap,
...
export { BUILT_IN_PANELS, CodePanel, Dashboard, ExchangePanel, GanttPanel, JsonPanel, ListPanel, LogPanel, MetricsPanel, ParamsPanel, PropertiesPanel, SpecAction, SpecActions, SpecChip, SpecChips, TablePanel, TextPanel, resolveRegistry };
