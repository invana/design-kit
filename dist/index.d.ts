 ...
 */
declare function RichSelect({ options, value, onChange, multiple, label, placeholder, renderOption, renderValue, align, tooltip, tooltipSide, disabled, triggerClassName, contentClassName, className, }: RichSelectProps): react_jsx_runtime.JSX.Element;
