...
function MarkdownEditorBlock({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: ui.cn("relative border border-border bg-muted/40", className), ...props, children: [
    version != null ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "absolute right-1 top-1 z-10 border border-border bg-card px-1 text-meta text-muted-foreground", children: version }) : null,
