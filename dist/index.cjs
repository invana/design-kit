...
function SpecChip({ chip }) {
  if (chip.bound)
    return /* @__PURE__ */ jsxRuntime.jsx(ui.BoundChip, { bound: chip.bound, swatch: chip.swatch });
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Badge,
    {
      ...
      ui.Item,
      {
        ...
        children: [
          ...
          item.meta || item.chip ? /* @__PURE__ */ jsxRuntime.jsxs(ui.ItemActions, { className: "min-w-0 shrink justify-end", children: [
            item.meta ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "max-w-[16ch] truncate font-mono text-sm text-muted-foreground", children: item.meta }) : null,
...
function TextPanel({ panel, options, onAction, icons }) {
  const body = /* @__PURE__ */ jsxRuntime.jsx("p", { className: ui.cn("text-sm", TEXT_TONE[options.tone ?? "muted"]), children: options.text });
...
function UnknownPanel({ kind }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "border border-dashed border-border p-3 text-sm text-muted-foreground", children: [
...
function Panel({
  ...
  const body = panel.absent ? /* @__PURE__ */ jsxRuntime.jsx(ui.AbsenceNote, { reason: panel.absent.reason, label: panel.absent.label, children: panel.absent.note }) : panel.render ?? (Renderer ? /* @__PURE__ */ jsxRuntime.jsx(
    Renderer,
    {
      panel,
...
function Row({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      children: row.panels.filter((panel) => !isDropped(panel)).map((panel, i) => /* @__PURE__ */ jsxRuntime.jsx(
        Panel,
        {
          panel,
          registry,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: ui.cn("flex min-h-0 flex-col bg-background", className), ...props, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        style: { gap },
        children: spec.rows.filter((row) => row.panels.some((panel) => !isDropped(panel))).map((row, i) => /* @__PURE__ */ jsxRuntime.jsx(
          Row,
          {
            row,
            gap,
...
function TracePanel({
  ...
  const step = (entry, key) => /* @__PURE__ */ jsxRuntime.jsx(
    ui.TraceStep,
    {
      seq: entry.seq,
      name: entry.name,
      ...
      note: entry.note,
      mark: entry.mark ? /* @__PURE__ */ jsxRuntime.jsx(ui.MarkChip, { tone: entry.markTone, children: entry.mark }) : void 0,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ui.TraceList, { children: options.entries.map((entry, i) => draw(entry, `${i}`)) });
}
function TouchedPanel({ options }) {
  return /* @__PURE__ */ jsxRuntime.jsx(ui.TouchStrip, { items: options.items, palette: options.palette });
}
function AttemptsPanel({ options }) {
  return /* @__PURE__ */ jsxRuntime.jsx(ui.AttemptClock, { rows: options.rows, summary: options.summary });
}
var RUN_PANELS = {
  trace: TracePanel,
...
function LensPanel({ options }) {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex flex-col gap-2", children: options.sections.map((section) => /* @__PURE__ */ jsxRuntime.jsx(
    ui.LayerSection,
    {
      layer: section.layer,
      ...
      dim: section.dim,
      children: (section.participants ?? []).map((participant) => /* @__PURE__ */ jsxRuntime.jsx(
        ui.ParticipantRow,
        {
...
exports.AttemptsPanel = AttemptsPanel;
...
exports.TouchedPanel = TouchedPanel;
