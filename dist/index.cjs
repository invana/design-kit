          ...
          /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
            ui.ToggleGroupItem,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("span", { className: "px-0.5 text-sm font-medium", children: t.name }),
    ...
    ui.RichSelect,
    {
      ...
      renderOption: (option) => /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex w-full items-center gap-3 py-0.5", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex min-w-0 flex-col", children: [
          ...
          option.description != null && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "line-clamp-1 text-sm text-muted-foreground", children: option.description })
        ] })
      ] }),
    ...
    ui.ToggleGroup,
    {
      ...
      children: MODES.map(({ value, label }) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(ui.Tooltip, { delayDuration: 0, children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(ui.ToggleGroupItem, { value, "aria-label": label, children: Icon ? /* @__PURE__ */ jsxRuntime.jsx(Icon, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntime.jsx("span", { className: "px-1 text-sm", children: label }) }) }),
