...
var ThemeProvider = ({
  ...
  const [isDark, setIsDark] = React2.useState(() => resolveIsDark(mode));
  React2.useEffect(() => {
    if (mode !== "system") {
      setIsDark(mode === "dark");
      return;
...
function useResolvedDark(mode, override) {
  const [isDark, setIsDark] = React2.useState(
          ...
          /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
            ui.ToggleGroupItem,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("span", { className: "px-0.5 text-xs font-medium", children: t.name }),
    ...
    ui.RichSelect,
    {
      ...
      renderOption: (option) => /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex w-full items-center gap-3 py-0.5", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex min-w-0 flex-col", children: [
          ...
          option.description != null && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "line-clamp-1 text-xs text-muted-foreground", children: option.description })
        ] })
      ] }),
    ...
    ui.ToggleGroup,
    {
      ...
      children: MODES.map(({ value, label }) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(ui.Tooltip, { delayDuration: 0, children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(ui.ToggleGroupItem, { value, "aria-label": label, children: Icon ? /* @__PURE__ */ jsxRuntime.jsx(Icon, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntime.jsx("span", { className: "px-1 text-xs", children: label }) }) }),
...
var Field = ({ stacked, label, inlineLabel, children }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [
    inlineLabel && /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-sm text-muted-foreground", children: [
      inlineLabel,
      ":"
    ] }),
    children
