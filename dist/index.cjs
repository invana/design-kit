                  ...
                  /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1", children: [
                    /* @__PURE__ */ jsxRuntime.jsx(
                      "button",
                      {
                        ...
                        className: `rounded px-1.5 py-0.5 text-meta ${pinned === "left" ? "bg-primary text-primary-foreground" : "bg-muted hover:bg-muted/70"}`,
                        children: "L"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntime.jsx(
                      "button",
                      {
                        ...
                        className: `rounded px-1.5 py-0.5 text-meta ${pinned === "right" ? "bg-primary text-primary-foreground" : "bg-muted hover:bg-muted/70"}`,
                        children: "R"
                      }
                    )
                  ] })
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(ui.TableBody, { children: table.getRowModel().rows.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx(ui.TableRow, { children: /* @__PURE__ */ jsxRuntime.jsx(
                  ...
                  return /* @__PURE__ */ jsxRuntime.jsxs(React2__namespace.Fragment, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx(ui.TableRow, { children: row.getVisibleCells().map((cell) => {
